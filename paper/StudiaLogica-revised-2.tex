...
\end{array}
\]
Curly brackets are used in Agda to denote implicit arguments. Therefore $\lleft ~f ~g$ is a term of type $\just ~(A \lolli B) \mid \GG \append~ \GD \vd C$, whenever we are given terms $f : \nothing \mid \GG \vd A$ and $g : \just ~B \mid \GD \vd C$. 
