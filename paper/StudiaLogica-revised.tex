...
For substructural logics that admit a cut-free sequent calculus, Craig interpolation is typically proven by adapting Maehara's method \cite{maehara1961,ono:proof:nonclassical:1998,roorda1991}, which originally aimed to prove interpolation for $\mathtt{LK}$, a sequent calculus for classical logic.
