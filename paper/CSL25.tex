...
\title{Craig Interpolation for Semi-{S}ubstructural Logics} %TODO Please add
...
\authorrunning{N. Veltri \& C.-S. Wan} %TODO mandatory. First: Use abbreviated first/middle names. Second (only in severe cases): Use first author plus 'et al.'

\Copyright{Niccol{\`o} Veltri and Cheng-Syuan Wan} %TODO mandatory, please use full first names. LIPIcs license is "CC-BY";  http://creativecommons.org/licenses/by/3.0/
...
\ccsdesc[500]{Theory of computation~Linear logic} %TODO mandatory: Please choose ACM 2012 classifications from https://dl.acm.org/ccs/ccs_flat.cfm 

\keywords{skew monoidal categories, Craig Interpolation, intuitionistic linear logic, Agda} %TODO mandatory; please add comma-separated list of keywords
...
\acknowledgements{We would like to thank Jan von Plato, who was an invited speaker at the World Logic Day 2024 in Tallinn, and on that occasion asked about Craig interpolation for \LSkG.
This work was supported by the Estonian Research Council grant PSG749.}%optional
